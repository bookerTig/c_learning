...
void month_ave(const float rain[][MONTHS]);
...
int main(void)
{
    ...
    /*calculate and print the monthly average rainfall data*/
    month_ave(rain);
...
//calculate the  yearly total and show it
void year_rain(const float rain[][MONTHS])
{
    int year, month;
    float subtot;
...
//calculate the total rainfall data
float total_rain(const float rain[][MONTHS])
{
    int year, month;
    float subtot, total;
